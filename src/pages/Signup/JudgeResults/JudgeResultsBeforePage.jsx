...
function JudgeResultsBeforePage () {
    ...
    return(
        <Container title={"입점 신청 완료"} containerWidth={containerSize[0]} containerHeight={containerSize[1]} logoMarginTop={containerSize[2]} logoMarginBottom="1.5rem">
            {/* <img src={basketicon} alt="basketicon" className="judge-results-before-page-top-positon-icon" /> */}
                ...
                <div className="judge-results-before-page-content-container">
                    ...
                    <div className="judge-results-before-page-content-main-text-style">
                        <span>1~2일 이내로 <img src={logo} alt="logo" style={{ 'width': '3.1rem', 'height': '0.8rem'}} />담당자가 사장님께 전화를 드리거나</span>
                    ...
                    <div className="redyvery-linked-message-for-kakao">
                        <img src={redyveryicon} alt="redyveryicon" className="redyvery-linked-message-for-readyvery-img" />
                        <div>
                        ...
                        <img src={kakaolinkedicon} alt="kakaolinkedicon" className="redyvery-linked-message-for-kakao-img" />
                    </div>
